"""
Configuration management - MySQL version
"""
import os
from datetime import timedelta

class Config:
    """Base configuration - MySQL version"""
    # Database - MySQL connection string
    DATABASE_URL = os.getenv('DATABASE_URL', 'mysql+pymysql://ngl_user:ngl_password@localhost:3306/ngl_db?charset=utf8mb4')
